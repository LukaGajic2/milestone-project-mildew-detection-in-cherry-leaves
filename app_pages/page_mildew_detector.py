...
def page_mildew_detector_body():
    ...
    st.info("The client is interested in predicting if a cherry leaf is "
            f"healthy or contains powdery mildew")
    st.write('---')

    st.write(
        f"* Upload your images for live prediction"
    ...
    images_buffer = st.file_uploader(
        'Upload leaf image samples. You may select more than one.',
        type=['jpg', 'png', 'gif', 'bmp', 'tif'], accept_multiple_files=True)
